...
<div className="bg-white border rounded-xl p-6 mb-6">
  ...
  <p className="text-sm text-gray-700">
    Based on the latest evaluation, the institution is currently
    <span className="font-semibold text-yellow-700"> partially compliant </span>
    under Criterion 2.
  </p>

  <p className="text-sm text-gray-700 mt-2">
    Student–Teacher Ratio meets NAAC benchmarks, however
    <span className="font-semibold text-red-700">
      {" "}student-centric teaching practices require improvement
    </span>
    to strengthen overall accreditation performance.
  </p>
</div>
