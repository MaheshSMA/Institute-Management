...
function FacultyStudents() {
  ...
  if (level === "urgent")
    return <span className="text-xs px-2 py-0.5 bg-red-100 text-red-700 rounded-full">Urgent</span>;
  if (level === "needs_attention")
    return <span className="text-xs px-2 py-0.5 bg-yellow-100 text-yellow-700 rounded-full">Needs Attention</span>;
  return null;
};
