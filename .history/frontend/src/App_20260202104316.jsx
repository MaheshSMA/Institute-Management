...
import ClubParticipants from "./pages/club/ClubParticipants";
import EventParticipants from "./pages/club/EventParticipants";
import ClubMessages from "./pages/club/ClubMessages";
...
function App() {
  ...
  return (
    <>
      ...
      <Route
        ...
        <Route
            ...
            element={<EditEvent />}
          />
      <Route path="/club/messages" element={<ClubMessages />} />
      <Route path="/club/messages/:studentId" element={<ClubChat />} />
      ...
      />
      <Route path="/club/participants" element={<ClubParticipants />} />
      <Route path="/club/participants/:eventId" element={<EventParticipants />} />
    ...
    <Route path="/club/events/edit/:id" element={<EditEvent />} />
      ...
      />
      <Route
        path="/student/clubs/:clubId/feed"
        element={<StudentClubFeed />}
      />
